...
--
-- Хост: 127.0.0.1
-- Время создания: Май 04 2017 г., 19:43
...
--
-- Структура таблицы `interlocutor`
--
...
--
-- Дамп данных таблицы `interlocutor`
--

INSERT INTO `interlocutor` (`id`, `id_user`, `id_interlocutor`) VALUES
(3, 82, 36),
(4, 36, 82),
(5, 36, 70),
(6, 70, 36);
...
CREATE TABLE IF NOT EXISTS `message` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Таблица, содержащая сообщения' AUTO_INCREMENT=105 ;

--
-- Дамп данных таблицы `message`
--

INSERT INTO `message` (`id`, `id_user_from`, `id_user_to`, `text_message`, `date`) VALUES
(2, 36, 82, 'Привет, Вася!', '2017-05-02 16:18:48'),
(3, 82, 36, 'Привет, Матвей.', '2017-05-02 16:18:59'),
(4, 82, 36, 'Как дала?', '2017-05-02 16:19:13'),
(5, 36, 82, 'Нормально!', '2017-05-02 16:32:47'),
(6, 36, 82, 'А у тебя как?', '2017-05-02 16:54:35'),
(7, 82, 36, 'Также. :-)', '2017-05-02 17:20:56'),
(8, 82, 36, 'Что делаешь?\r\n', '2017-05-02 17:22:11'),
(9, 82, 36, 'Ммм?', '2017-05-02 17:23:28'),
(10, 36, 82, 'Ну, я думаю, все хорошо', '2017-05-02 17:36:08'),
(11, 82, 36, 'Это замечательно, что у тебя все хорошо! :-)', '2017-05-02 17:51:38'),
(26, 70, 36, 'Привет', '2017-05-02 19:25:31'),
(28, 36, 1, 'Привет всем! Я Матвей!', '2017-05-02 19:45:52'),
(29, 36, 1, 'Почему по 2 сообщения сохраняет?', '2017-05-02 19:46:09'),
(30, 70, 1, 'Привет.', '2017-05-02 19:47:34'),
(31, 70, 1, 'У меня одно сообщение.', '2017-05-02 19:47:47'),
(55, 70, 1, 'Как дела?rnБудет ли работать чат?rnИли нет? Ну, что там!!!', '2017-05-02 21:39:56'),
(56, 70, 1, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', '2017-05-02 21:47:06'),
(57, 36, 70, 'Привет, Котофей, чем занимаешься?', '2017-05-02 22:00:45'),
(58, 70, 36, 'Сплю на клавиатуре. :-)', '2017-05-02 22:09:09'),
(59, 36, 70, 'Здорово, ладушки, я отлучусь.', '2017-05-02 22:09:28'),
(92, 36, 70, '<p><img src="http://www.pravoslavie.ru/sas/image/100575/57595.b.jpg" alt="" width="358" height="389" /></p>', '2017-05-02 23:58:51'),
(96, 36, 70, '<p><img src="http://www.2photo.ru/uploads/posts/4268/20090828/my-shots/28_08_2009_0047196001251442423_my-shots.jpg" alt="Русь" width="131" height="285" />Это красивая фотография русской природы!&nbsp;</p>', '2017-05-03 00:07:59'),
(97, 36, 70, '<pre class="language-javascript"><code>var a = 2;\r\na + 2;</code></pre>\r\n<p>&nbsp;</p>', '2017-05-03 00:36:52'),
(98, 36, 1, '<p><img src="data:image/png;base64," alt="sealed" width="34" height="39" /></p>', '2017-05-03 01:03:36'),
(99, 70, 36, '<p>Что это<span style="color: #ff0000;">???</span></p>', '2017-05-03 01:27:53'),
(100, 36, 1, '<p>Работает ли общий чат???&nbsp;<img src="../../template/js/tinymce/plugins/emoticons/img/smiley-laughing.gif" alt="laughing" /></p>\r\n<p>Жаль что не используется AJAX.<img src="../../template/js/tinymce/plugins/emoticons/img/smiley-frown.gif" alt="frown" /></p>', '2017-05-03 02:21:58'),
(101, 70, 1, '<h4 style="text-align: center;">Чат работает и это хорошо.</h4>\r\n<p>Но очень плохо, что каждый раз приходится нажимать на клавишу &nbsp;F5, чтоьы просмотреть не пришли ли новые сообщения.<img src="../../template/js/tinymce/plugins/emoticons/img/smiley-yell.gif" alt="yell" width="46" height="46" /></p>', '2017-05-03 02:25:46');
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `day_birthday` int(11) NOT NULL,
  `month_birthday` varchar(20) NOT NULL,
  `year_birthday` int(11) NOT NULL,
  `country` varchar(100) NOT NULL,
  `city` varchar(100) NOT NULL,
  `about_me` text NOT NULL,
  `show_personal_data` int(11) NOT NULL,
  `date_registration` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='Таблица, содержащая пользователей' AUTO_INCREMENT=83 ;

--
-- Дамп данных таблицы `user`
--

INSERT INTO `user` (`id`, `name`, `surname`, `login`, `password`, `e_mail`, `url_avatar`, `day_birthday`, `month_birthday`, `year_birthday`, `country`, `city`, `about_me`, `show_personal_data`, `date_registration`) VALUES
(1, 'common', '', '', '', '', '', 0, '0', 0, '', '', '', 0, '0000-00-00 00:00:00'),
(36, 'Матвей', 'Калин', 'matthewk', '6cb933086409327d15b286acd1cbd2b19eb7673f', 'matthewk@mail.ru', 'template/img/users_avatar/foto.jpg', 23, 'Август', 0, 'Russian Federation', 'Perm', 'Это тайная информация! &lt;&amp;:^)', 0, '2016-10-15 15:20:36'),
(70, 'Кот', 'Котофей', 'qwe', '056eafe7cf52220de2df36845b8ed170c67e23e3', 'qwe@mail.ru', 'template/img/users_avatar/25973123-906821771.jpg', 0, '', 0, '', '', '', 0, '0000-00-00 00:00:00'),
(82, 'Вася', 'Пупкин', 'asdasd', '85136c79cbf9fe36bb9d05d0639c70c265c18d37', 'vasya@mail.ru', '', 0, '', 0, '', '', '', 0, '0000-00-00 00:00:00');
